...
\def\Az{\phi_\textrm{Az}}
\def\dAz{\dot{\phi}_\textrm{Az}}
\def\El{\phi_\textrm{El}}
\def\dOPD{\dot{\textrm{OPD}}}
...
\def\inertia{J}
\def\inertial{I}
\def\inertiaVec{\boldsymbol\inertia}
\def\angpos{\theta}
\def\angvel{\omega}
...
\def\ccmgtorque{\torque_{\CCMG,z}}
\def\momdumptorque{\torque_{\textrm{Mom.},z}}
