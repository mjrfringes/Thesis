...
\paragraph{Accretion physics}

Perhaps the most elementary way to model the birth of a star consists of considering an isothermal sphere of self-gravitating gas on the verge of collapse. This is also called a Bonnor-Ebert sphere, and the state of this sphere is said to be \textit{critically stable}. Collapse occurs when gravity overcomes the gas pressure inside the sphere, which triggers the birth of a YSO. Magnetic fields, turbulence, asymmetries and non-isothermal considerations all likely play role in this balance, but dramatically complicate the mathematical treatment of the problem. In order to introduce the basic concepts of star formation, these complex processes are ignored. 
