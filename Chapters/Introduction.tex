...
\begin{table}[htbp]
\small
\begin{longtable}{p{3cm}ccp{3cm}p{2cm}p{2cm}}
\toprule
Noise source	&		T (K)		&		Emissivity		&	Reference	&		$N_\textrm{photons}$ Band 1		&		$N_\textrm{photons}$ Band 2		\\
\midrule
Warm optics	&	\num{	240	}	&	\num{	0.1	}	&	Assumes 99\% per mirror	&	\num{	1.38E+11	}	&	\num{	9.97E+10	}	\\
Window	&	\num{	240	}	&	\num{	0.02	}	&	Lab measurements	&	\num{	2.76E+10	}	&	\num{	1.99E+10	}	\\
Zodi dust	&	\num{	245	}	&	\num{	3.00E-07	}	&	\cite{Fixsen:2002da}	&	\num{	2.92E+05	}	&	\num{	3.41E+05	}	\\
Galactic Cirrus	&	\num{	20.00	}	&	\num{	1.23E-04	}	&	\cite{Bracco:2011gw}	&	\num{	1.79E+01	}	&	\num{	7.67E+04	}	\\
Zodi sunlight scattering	&	\num{	5800	}	&	\num{	1.00E-13	}	&	\cite{Fixsen:2002da}	&	\num{	1.47E+01	}	&	\num{	1.31E+01	}	\\
CIB	&	\num{	18.5	}	&	\num{	1.30E-05	}	&	\cite{Fixsen:1998br}	&	\num{	2.19E+00	}	&	\num{	9.68E+03	}	\\
Instrument	&	\num{	4	}	&	\num{	0.7	}	&	Estimate	&	\num{	5.80E-27	}	&	\num{	2.50E-07	}	\\
CMB	&	\num{	2.728	}	&	\num{	1	}	&	\cite{Fixsen:1996di}	&	\num{	1.02E-45	}	&	\num{	9.35E-17	}	\\
\bottomrule
\end{longtable}
