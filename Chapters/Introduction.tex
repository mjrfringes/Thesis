...
\end{align}
%
where \Snu is the flux density in \si{\watt\per\raiseto{2}\meter\per\hertz}. We will use these simple diagnostics later in our analysis of our SOFIA FORCAST data.
