...
\begin{figure}[!h]
		...
		\caption[Cryostat top plate]{Cryostat top plate.}
...
\begin{figure}[!h]
		\centering
		\includegraphics[width=\textwidth]{Figures/DetectorTesting.jpg} 
		\caption[Detector testing]{Detector testing in a test dewar.}
		\label{fig:DetectorTesting}
\end{figure}
