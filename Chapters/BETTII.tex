...
A ($^3$He+$^4$He) sorption refridgerator from Chase Research cools down the main optical bench to \SI{4}{\kelvin} (see Fig.~\ref{fig:CryostatTopPlate} for a picture of the top plate of the cryostat while cold). It also has an intermediate cold finger at \SI{1}{\kelvin} and a final stage that brings down the detector temperature to $\sim$\SI{400}{\milli\kelvin}. 
