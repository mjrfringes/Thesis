...
\midrule															
Sum of point sources in cluster	&	124.65	&	123.70	&	1021.40	&	2821.76	&	2354.00	&	3156.58	&	3330.00	\\
...
Data with available long-wavelength data (for good estimate of Lbol)
Plots: Lestimated vs Lbol; explain differences (noisy data)
R distribution
envmass/lum vs alpha

show table with fluxes and derived parameters

show that inclinations decrease with mass; could be an artifact

Show SED mosaics.

\subsection{Estimating parameter uncertainty}
show uncertainties and discuss how they are determined
show cross-correlation/cloud diagrams for a few targets

Plot fractional error of all fits
...
\begin{figure*}
\begin{center}
\includegraphics[width=1.6\textwidth]{Figures/NGC2071_IRAS20050_RGB.png}
...
\begin{table}[!h]
\scriptsize
\caption[Source fluxes in IRAS~20050+2720's dense core]{Sources fluxes (Jy) in IRAS~20050+2720.}
...
\midrule																																							
IRAS20050.1	&	20h07m06.638s +27d28m47.971s	&	0.214	$\pm$	0.021	&	0.489	$\pm$	0.049	&	0.57	$\pm$	0.057	&	0.731	$\pm$	0.073	&	0.858	$\pm$	0.086	&	0.64	$\pm$	0.07	&	1.93	$\pm$	0.20	&	4.50	$\pm$	0.35	&	6.32	$\pm$	0.59	\\
IRAS20050.2	&	20h07m06.197s +27d28m49.127s	&	0.002	$\pm$	0.002	&	0.041	$\pm$	0.004	&	0.142	$\pm$	0.014	&	0.264	$\pm$	0.026	&	0.308	$\pm$	0.031	&	0.06	$\pm$	0.06	&	1.45	$\pm$	0.19	&	9.31	$\pm$	0.72	&	11.96	$\pm$	1.19	\\
IRAS20050.3	&	20h07m06.319s +27d28m56.568s	&	0.028	$\pm$	0.003	&	0.09	$\pm$	0.009	&	0.218	$\pm$	0.022	&	0.339	$\pm$	0.034	&	0.429	$\pm$	0.043	&	0.18	$\pm$	0.06	&	2.58	$\pm$	0.27	&	12.53	$\pm$	0.94	&	19.34	$\pm$	1.41	\\
IRAS20050.4	&	20h07m05.858s +27d28m59.182s	&	0.002	$\pm$	0.002	&	0.023	$\pm$	0.003	&	0.039	$\pm$	0.004	&	0.053	$\pm$	0.008	&	0.055	$\pm$	0.008	&	0.06	$\pm$	0.05	&	0.25	$\pm$	0.20	&	8.54	$\pm$	0.80	&	12.85	$\pm$	1.25	\\
IRAS20050.5	&	20h07m06.571s +27d28m53.137s	&	0.042	$\pm$	0.004	&	0.118	$\pm$	0.012	&	0.176	$\pm$	0.018	&	0.235	$\pm$	0.024	&	0.32	$\pm$	0.032	&	0.19	$\pm$	0.05	&	1.03	$\pm$	0.21	&	2.97	$\pm$	0.33	&	5.65	$\pm$	0.65	\\
IRAS20050.6	&	20h07m02.172s +27d30m26.014s	&	0.155	$\pm$	0.016	&	0.537	$\pm$	0.054	&	0.771	$\pm$	0.077	&	1.113	$\pm$	0.111	&	1.805	$\pm$	0.181	&	1.81	$\pm$	0.13	&	2.29	$\pm$	0.17	&	1.64	$\pm$	0.14	&	1.22	$\pm$	0.38	\\
IRAS20050.7	&	20h07m07.927s +27d27m15.782s	&	0.002	$\pm$	0.002	&	0.004	$\pm$	0.004	&	0.024	$\pm$	0.002	&	0.06	$\pm$	0.006	&	0.072	$\pm$	0.007	&	0.06	$\pm$	0.05	&	0.11	$\pm$	0.06	&	1.15	$\pm$	0.14	&	2.09	$\pm$	0.31	\\\bottomrule					
	\end{longtable} 
\end{table}
...
[Talk about the mass distribution, luminosities, etc].
...
In testing the various scenarios of star formation, it is useful to obtain a measure of how much mass is available for the YSOs to grow after their original collapse. For this, clustered regions such as this one are an ideal laboratory since the YSOs usually appear to share an envelope. However, appropriately measuring the flux from each individual source is challenging, since the sources are so close together. With an aperture of \ang{;;2.4} (3 pixel radius), we managed to put non-overlapping apertures for all the 5 sources. Since the aperture correction was derived considering a "total flux" aperture to be $\sim$12 pixel radius, we are accounting for the same flux multiple times, even if the apertures are not overlapping. If we estimate the \SI{37}{\um} flux from the eastern extended emission to be totalling $\sim\SI{5}{\Jy}$, we obtain a surplus of about 22\%


However, the apertures for IRAS20050.3 and IRAS20050.5 are touching, which means that we measure the same amount of flux twice. We anticipate that this effect is on the order of $\sim$\SI{3-4}{\Jy} at \SI{37}{\um}, based on photometry in other apertures adjacent to IRAS20050.3 to the north-east of the source. This amounts to the flux estimated from IRAS20050.5, which would then be significantly smaller, at $\sim\SI{2}{\Jy}$ and reducing the sum of point sources to \SI{53}{\Jy}. The presence of short wavelength counterparts to IRAS20050.5 pushes to keep identifying this source as its own source. Even taking into account this error, it appeared that we cannot reconcile our individual source photometry with the total photometry of the cluster, since at least $\sim\SI{6}{\Jy}$ must come from the extended eastern emission at \SI{37}{\um}. Since can be explained a few different ways.

One possibility is that the individual sources are not actually point sources, but have more extended shapes that would contaminate one another when doing aperture photometry (which means that we measure the same flux multiple times). Given the typical separation between the sources of \ang{;;6-8} or projected distances of \SI{3000-5600}{\au}, this is possible. The outflow activity inside this cluster could also facilitate heating from the individual stars to extended our to larger distances within the envelopes, explaining the strong \SI{37}{\um} diffuse emission which appears to surround the YSOs. This scenario favors the competitive accretion model where protostars are competing from the same reservoir of mass.

One other possibility is that outflow-powered heating is happening inside the cluster and around the YSOs, creating more diffuse emission
...
SOFIA name	&	F11	&	F19	&	F31	&	F37	\\
\midrule									
NGC2071.1	&	9.04	&	63.52	&	146.31	&	208.14	\\
NGC2071.2	&	0.29	&	9.17	&	46.28	&	72.48	\\
NGC2071.3	&	0.26	&	2.65	&	17.52	&	32.52	\\
\midrule									
Sum of point sources in cluster	&	9.60	&	75.35	&	210.11	&	313.15	\\
Total cluster emission	&	11.33	&	94.04	&	277.78	&	357.19	\\
Ratio	&	1.18	&	1.25	&	1.32	&	1.14	\\
\bottomrule					
	\end{longtable} 
\end{table}
