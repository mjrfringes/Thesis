...
\caption[NGC1333 SEDs]{SEDs of the point sources in NGC1333.}
\end{center}
\end{figure}
...
\label{fig:Oph_SEDs}
\caption[Ophiuchus SEDs]{SEDs of the point sources in the Ophiuchus cluster.}
\end{center}
\end{figure}
...
\subsection{Fitted physical parameters and sample statistics}
...
\toprule																									
SOFIA Name	&	Coordinates	&	R37	&	$\alpha$	&	R	&	\Menv			&	\Ltot			&	$\Lbol$	&	Inc.	&	Ext.	&	$s$	\\
