...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=1.6\textwidth]{Figures/starcam_images.pdf}
	\caption[Star camera example WISE]{Star camera image (left) with identified sources circled in red. WISE \SI{3.4}{\um} image (right) with the same circles overlaid.}
