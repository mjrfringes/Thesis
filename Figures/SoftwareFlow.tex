...
\coordinate (O) at (0,0);
\node[block,name=gyro loop,anchor=west] at (O){BOOP FPGA\\ Trigger sensors};
...
\draw[thick,double] (-0.3,-8) -- (-0.3,2)node[above=1em,align=center]{\SI{100}{\hertz} Control \\ clock tick};
\draw[thick,double] (9.7,-8) -- (9.7,2)node[above=1em,align=center]{\SI{100}{\hertz} Control \\ clock tick};
\draw[thick,double] (19.7,-8) -- (19.7,2)node[above=1em,align=center]{\SI{100}{\hertz} Control \\ clock tick};

\node[block,name=gyro loop2,anchor=west,xshift=10cm] at (O){BOOP FPGA\\ Trigger sensors};
