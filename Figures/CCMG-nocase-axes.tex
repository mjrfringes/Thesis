...
\node at (O){\includegraphics[width=\textwidth]{Figures/CCMG-nocase.png}};

\draw[->,red,line width=\linewidth] (O) -- (0,0,\axissize)node[right]{\z};
\draw[->,red,line width=\linewidth] (O) -- (0,\axissize,0)node[right]{\x};
\draw[->,red,line width=\linewidth] (O) -- (-\axissize,0,0)node[below]{\y};
