...
% sky plane
\draw[->] (0,0,\axislength) -- (0,0,-\axislength)node[below]{$\theta'_x$};
...
% pupil plane
\draw[->] (\planedist,0,-\axislength) -- (\planedist,0,\axislength)node[above]{$u$};
\draw[->] (\planedist,\axislength,0) -- (\planedist,-\axislength,0)node[above]{$v$};
\tdplotsetrotatedcoords{0}{90}{0}
\draw[tdplot_rotated_coords,dashed] (0,0,\planedist) circle (0.4*1.41*\axislength);
\draw[tdplot_rotated_coords,fill opacity=0.5,fill=gray] (-0.4*\axislength,0.4*\axislength,\planedist) circle (0.1*\axislength);
\draw[tdplot_rotated_coords,fill opacity=0.5,fill=gray] (0.4*\axislength,-0.4*\axislength,\planedist) circle (0.1*\axislength);
\draw[tdplot_rotated_coords,<->] (-0.4*\axislength,0.4*\axislength,\planedist) -- (0.4*\axislength,-0.4*\axislength,\planedist)node[pos=0.2,below,fill=white,inner sep=0.1cm]{\vectors{B}};

% pupil plane #2
\draw[->] (2*\planedist,0,-\axislength) -- (2*\planedist,0,\axislength)node[above]{$u$};
\draw[->] (2*\planedist,\axislength,0) -- (2*\planedist,-\axislength,0)node[above]{$v$};
\draw[tdplot_rotated_coords,fill opacity=0.5,fill=gray] (-0.02*\axislength,0.02*\axislength,2*\planedist) circle (0.1*\axislength);
\draw[tdplot_rotated_coords,fill opacity=0.5,fill=gray] (0.02*\axislength,-0.02*\axislength,2*\planedist) circle (0.1*\axislength);

% image plane
\draw[->] (3*\planedist,0,-\axislength) -- (3*\planedist,0,\axislength)node[above]{$\theta_x$};
...
\draw[tdplot_rotated_coords] (-0.7*\axislength,0.7*\axislength,3*\planedist) -- (0.7*\axislength,-0.7*\axislength,3*\planedist)node[below,align=center]{baseline \\ direction};
